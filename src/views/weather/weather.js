...
var weather = template.kind({
  ...
  controlComponents: [
    {name: 'forecast', kind: forecast, components: [
  ...
  dataChanged: function() {
    ...
    this.$.icon.addClass(this.setWeatherIcon(this.data.item.condition.code));
    ...
    this.$.forecast.set('content', this.data.item.forecast);
  },
  setWeatherIcon: function (condid) {
    var icon;
    switch(condid) {
